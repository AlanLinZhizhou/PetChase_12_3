...
import com.example.linzhizhou.petchase_12_3.navigate.util.ErrorInfo;
import com.example.linzhizhou.petchase_12_3.navigate.util.TTSController;
...
public class BaseActivity extends Activity implements AMapNaviListener, AMapNaviViewListener {
    ...
    protected NaviLatLng mEndLatlng = new NaviLatLng(32.183602,118.699000);//默认的起点
    protected NaviLatLng mStartLatlng = new NaviLatLng(32.185934,118.689972);//默认的终点
